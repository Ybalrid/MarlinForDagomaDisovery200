...
#define STRING_CONFIG_H_AUTHOR "(Arthur (Ybalrid) Brainville, for RED @ESIEA)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "RED Prusa i3 eMotionTech"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  //Prusa i3 emotion tech "RED" at 200C autotuned with PLA inserted inside the hot end, autonuned with 8 cycles :
  #define  DEFAULT_Kp 30.61
  #define  DEFAULT_Ki 2.08
  #define  DEFAULT_Kd 112.84
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 622 } //manual calibration of E0
